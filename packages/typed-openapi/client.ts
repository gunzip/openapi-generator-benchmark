...
export const EnumTest = z.object({
  status: z.union([z.literal("value1"), z.literal("value2"), z.literal("value3")]).optional(),
});
...
export const DisjointUnionsUserTest = z.union([EnabledUserTest, DisabledUserTest]);
...
>;
export const ObjectDefinitionWithImplicitTypeAndAdditionalProperties = z.unknown();
...
export type post_TestParameterWithReference = typeof post_TestParameterWithReference;
...
export type post_TestParameterWithBodyReference = typeof post_TestParameterWithBodyReference;
...
export type put_PutTestParameterWithBodyReference = typeof put_PutTestParameterWithBodyReference;
...
export type get_TestParameterWithDashAnUnderscore = typeof get_TestParameterWithDashAnUnderscore;
...
export type get_TestParametersAtPathLevel = typeof get_TestParametersAtPathLevel;
...
export const EndpointByMethod = {
  get: {
    ...
    "/test-parameter-with-dash-and_underscore/{path-param}": get_TestParameterWithDashAnUnderscore,
