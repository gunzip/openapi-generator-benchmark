...
export class TestSimpleToken<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {
 ...
 */
testSimpleToken: (query: TestSimpleTokenParams, params: RequestParams = {}) =>
    this.request<TestSimpleTokenData, void>({
