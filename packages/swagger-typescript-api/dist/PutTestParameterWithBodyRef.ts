...
export class PutTestParameterWithBodyRef<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {
...
putTestParameterWithBodyReference: (data: NewModel, params: RequestParams = {}) =>
    this.request<PutTestParameterWithBodyReferenceData, void>({
