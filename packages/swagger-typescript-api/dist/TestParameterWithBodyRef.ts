...
export class TestParameterWithBodyRef<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {
...
testParameterWithBodyReference: (data: NewModel, params: RequestParams = {}) =>
    this.request<TestParameterWithBodyReferenceData, void>({
