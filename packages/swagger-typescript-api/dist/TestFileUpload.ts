...
export class TestFileUpload<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {
 ...
 */
testFileUpload: (data: TestFileUploadPayload, params: RequestParams = {}) =>
    this.request<TestFileUploadData, any>({
