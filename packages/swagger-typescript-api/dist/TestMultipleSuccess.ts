...
export class TestMultipleSuccess<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {
...
testMultipleSuccess: (params: RequestParams = {}) =>
    this.request<TestMultipleSuccessData, TestMultipleSuccessError>({
