...
export class TestMultiContentTypes<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {
 ...
 */
testMultiContentTypes: (data: NewModel, params: RequestParams = {}) =>
    this.request<TestMultiContentTypesData, any>({
