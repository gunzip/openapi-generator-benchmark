...
export class TestPathLevelParameter<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {
 ...
 */
testParametersAtPathLevel: (query: TestParametersAtPathLevelParams, params: RequestParams = {}) =>
    this.request<TestParametersAtPathLevelData, void>({
