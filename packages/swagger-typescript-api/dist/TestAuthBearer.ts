...
export class TestAuthBearer<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {
 ...
 */
testAuthBearer: (query: TestAuthBearerParams, params: RequestParams = {}) =>
    this.request<TestAuthBearerData, void>({
