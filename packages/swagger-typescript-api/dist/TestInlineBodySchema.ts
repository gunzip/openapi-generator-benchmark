...
export class TestInlineBodySchema<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {
 ...
 */
testInlineBodySchema: (data: TestInlineBodySchemaPayload, params: RequestParams = {}) =>
    this.request<TestInlineBodySchemaData, any>({
