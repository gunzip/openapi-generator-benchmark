...
export class TestWithOverriddenSecurity<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {
 ...
 */
testOverriddenSecurity: (params: RequestParams = {}) =>
    this.request<TestOverriddenSecurityData, any>({
