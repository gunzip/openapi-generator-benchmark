...
export class TestDeserialization<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {

            /**
 * No description
 *
 * @name TestDeserialization
 * @request GET:/test-deserialization
 * @response `200` `TestDeserializationData` Ok
 */
testDeserialization: (params: RequestParams = {}) =>
    this.request<TestDeserializationData, any>({
