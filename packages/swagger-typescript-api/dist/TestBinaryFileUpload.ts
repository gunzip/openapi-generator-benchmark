...
export class TestBinaryFileUpload<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {
 ...
 */
testBinaryFileUpload: (data: TestBinaryFileUploadPayload, params: RequestParams = {}) =>
    this.request<TestBinaryFileUploadData, any>({
