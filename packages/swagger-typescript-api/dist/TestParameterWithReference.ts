...
export class TestParameterWithReference<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {
 ...
 */
testParameterWithReference: (query: TestParameterWithReferenceParams, params: RequestParams = {}) =>
    this.request<TestParameterWithReferenceData, void>({
