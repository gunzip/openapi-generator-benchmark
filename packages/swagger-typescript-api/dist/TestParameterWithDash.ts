...
export class TestParameterWithDash<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {
 ...
 */
testParameterWithDash: ({ pathParam, ...query }: TestParameterWithDashParams, params: RequestParams = {}) =>
    this.request<TestParameterWithDashData, void>({
