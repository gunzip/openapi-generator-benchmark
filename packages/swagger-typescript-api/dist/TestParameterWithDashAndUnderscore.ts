...
export class TestParameterWithDashAndUnderscore<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {
 ...
 */
testParameterWithDashAnUnderscore: ({ pathParam, ...query }: TestParameterWithDashAnUnderscoreParams, params: RequestParams = {}) =>
    this.request<TestParameterWithDashAnUnderscoreData, void>({
